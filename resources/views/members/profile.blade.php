      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="d-flex align-items-center">
            <span>Account Number</span><span class="ms-2 rounded bg-body-secondary px-3 py-2">{{ $client->user->account_number }}</span>
          </div>
                ...
                <div class="container">
                  ...
                  <form action="{{ route('member.profile.store') }}" method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <input type="text" class="form-control" name="last_name" id="last_name" value="{{ $client->last_name }}" readonly disabled>
                        </div>
                        <div class="col-lg-4">
                        <label for="middle_name">Middle Name</label>
                            <input type="text" class="form-control" name="middle_name" id="middle_name" value="{{ $client->middle_name }}" readonly disabled>
                        </div>
                        <div class="col-lg-4">
                        <label for="first_name">First Name</label>
                        <input type="text" class="form-control" name="first_name" id="first_name" value="{{ $client->first_name }}" readonly disabled>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <input type="text" class="form-control" name="city_address" id="city_address" value="{{ $client->city_address }}">
                        </div>
                        <div class="col-lg-4">
                        <label for="phone_num">Phone Number</label>
                        <input type="text" class="form-control" name="phone_num" id="phone_num" value="{{ $client->phone_number }}">
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row mb-3">
                        ...
                        <label for="spouse_name">Name of Spouse</label>
                            <input type="text" class="form-control" name="spouse_name" id="spouse_name" value="{{ $client->spouse_name }} ">
                        </div>
                        <div class="col-lg-4">
                        <label for="provincial_address">Provincial Address</label>
                        <input type="text" class="form-control" name="provincial_address" id="provincial_address" value="{{ $client->provincial_address }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <input type="text" class="form-control" name="citizenship" id="citizenship" value="{{ $client->citizenship }} ">
                        </div>
                        <div class="col-lg-4">
                        <label for="birth_date">Date of Birth</label>
                            <input type="date" class="form-control" name="birth_date" id="birth_date" value="{{ $client->birth_date ? $client->birth_date->format('Y-m-d') : old('birth_date') }}">
                        </div>
                        <div class="col-lg-4">
                        <label for="birth_place">Place of Birth</label>
                        <input type="text" class="form-control" name="birth_place" id="birth_place" value="{{ $client->birth_place }} ">
                        </div>
                    </div>
                    <!-- Row 5-->
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            ...
                            <input type="text" class="form-control" name="taxID_num" id="taxID_num" value="{{ $client->tax_id_number }}">
                        </div>
                        <div class="col-lg-4">
                            <label for="mailing_address">Mailing Address</label>
                            <input type="text" class="form-control" name="mailing_address" id="mailing_address" value="{{ $client->mailing_address }}">
                        </div>
                        <div class="col-lg-4">
                            <label for="date_employed">Date of Employment</label>
                            <input type="date" class="form-control" name="date_employed" id="date_employed" value="{{ $client->date_employed->toDateString() }}" readonly disabled>
                        </div>
                    </div>
                    <!-- Row 6-->
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            ...
                            <select class="form-control" name="natureOf_work" id="natureOf_work" value="{{ $client->nature_of_work }}">
                        ...
                        <div class="row d-flex">
                            ...
                            <div class="col-lg-4 ">
                                <div class="w-auto mb-3">
                                    <div >Current email: <div class="text-success">{{ $client->user->email }}</div></div>
                                </div>
                            </div>
