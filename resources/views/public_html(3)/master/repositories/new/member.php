            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="row mt-1">
                      ...
                      <div class="col-lg-8 col-md-8 col-sm-8 flex-start flex-column">
                        ...
                        <div class="row mb-3">
                          <div class="col-md-8 d-flex justify-content-between">
                            <div id="acc-number" class="ms-0 pb-1 w-auto"><?php echo $account_number; ?>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md-8 d-flex justify-content-between">
                            <div id="acc-password" class="ms-0 pb-1 w-auto"><?php echo $password; ?>
                  ...
                  <div class="col-lg-12">
                    <!-- Table -->
                    <form id="memberForm" action="/master/repositories/api/newEntry.php" method="post" onsubmit="return validateForm()">                  
...
<!-- Fetching data -->
<script src="/master/repositories/static/fetch.js"></script>
<!-- Clipboard -->
...
$(document).ready(function() {
  $("#memberForm").on("submit", function(e) {
    ...
    // AJAX request
    $.ajax({
      url: "/master/repositories/api/newEntry.php",
      type: "post",
      data: $(this).serialize(),
      success: function() {
        ...
        setTimeout(function() {
          window.location.href = "/master/repositories/repositories.php";
